...
required CSS style for the list. Also don't forget to include jquery and the jquery customdata plugin (plugin will be copied by the generator).*
...
<pre>
  ...
  <%= javascript_include_tag "jquery.customdata" %>
